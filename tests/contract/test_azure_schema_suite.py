...
def test_every_phase4_tool_schema_is_azure_compatible() -> None:
...
def test_lab_and_phase2_catalog_isolates_a_single_bad_tool() -> None:
    ...
    schemas.update(phase4_input_schemas())
    ...
    assert "propose_restart_workload" in report.compatible_tools
...
def test_fastmcp_generated_schemas_are_azure_compatible() -> None:
    ...
    generated.update(fastmcp_input_schemas(remediation_mcp))
    expected = set(phase2_input_schemas()) | set(phase4_input_schemas())
